...
<body class="bg-light">
    ...
    <div id="page" class="bg-white pb-4">
        <h5 class="fw-semibold px-3 pt-3">Lab Request</h5>
        <hr>
        <section>
          <div class="table-responsive">
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">SL</th>
                        <th scope="col" class="w-25">Name of the head of the lab</th>
                        <th scope="col">Designation</th>
                        <th scope="col">Name of the lab</th>
                ...
                <tbody class="">
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-outline-warning px-4 text-dark fw-bold me-2">Approved</button>
